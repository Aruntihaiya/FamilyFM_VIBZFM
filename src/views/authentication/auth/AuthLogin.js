...
const AuthLogin = ({ subtitle }) => {
  ...
  return (
    <div className="auth-form-container">
      <h2>Login </h2>
      <p style={{textAlign:'center' ,fontWeight:'200'}}>Please enter your login details!</p>
      <Formik
                ...
                if (response.data.code !== 200) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      axios
                        .post(
                          'http://192.168.29.28:8080/api/public/checkauthrization',
                          {},
                          {
          ...
          <Form className="login-form">
            <Row>
              <Col md={12} className="mt-3">
                ...
                <Field type="email" name="email" className="form-control-log" placeholder=' Enter Email'/>
              ...
              <Col md={12} className="mt-3">
                ...
                <Field type="password" name="password" className="form-control-log" placeholder='Enter Password' />
                <ErrorMessage name="password" component="div" className="text-warning" />
              </Col>
              <Col md={12}>
                <Link to="/forgetpassword">
                  <div className="link-btn" style={{ float: 'right',color:'#f8d20e' }}>
                    Forget password
                  </div>
                </Link>
              </Col>
